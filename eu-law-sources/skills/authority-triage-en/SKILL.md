...
metadata:
  ...
  version: "1.0.0"
  inspiration: "swiss-legal-source-authority-triage (Enrique G. Zbinden, MIT) - the 'route authority before answer' pattern; the PL/EU substance written from scratch"
